...
<div className='mt-12'>
  ...
  />
            ...
            <button type='submit' className='submitRegisterForm transition-colors duration-300 ease-in-out md:w-[400px] lg:w-[600px] w-[300px]' onClick={handleFormSubmission}>Create an account</button>
        </form>
    </div>
    </div>
    </>
